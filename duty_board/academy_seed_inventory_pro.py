"""ZhiftERP Inventory Management Professional track seed — the warehouse curriculum.
...
ORDER = ["warehouses", "stock_entries", "serial_batch", "counting", "valuation", "branch_network", "stock_health", "advanced_inventory"]
