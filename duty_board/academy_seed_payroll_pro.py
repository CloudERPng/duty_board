"""ZhiftERP Payroll Professional track seed — the compensation
...
ORDER = ["payroll_function", "statutory", "payroll_run", "payslips", "variable_pay", "pay_reviews", "exits_special", "advanced_payroll"]
