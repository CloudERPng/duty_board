"""ZhiftERP HR Professional track seed — the people curriculum
...
ORDER = ["employee_master", "recruitment", "attendance", "leave", "performance", "training", "lifecycle", "advanced_hr"]
