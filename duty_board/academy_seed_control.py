...
Seeded deliberately while INCOMPLETE. Four of nine modules are written, and the
...
Consequences of publishing early, and how each is handled:
  ...
  - The description says plainly that it is in preparation. If the flag is ever
    ...
    thin course.
  - Reconciles the module list on every run, so modules 3, 7, 8, 1 and 9
...
ORDER = ["getting_data", "procure_pay", "inventory", "revenue_pos"]
...
TRACK = {
    ...
    "seat_price": 85000,
    "description": (
        "IN PREPARATION — four of nine modules published for review. "
