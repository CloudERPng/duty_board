...
Seeded deliberately while INCOMPLETE. Eight of nine modules are written, and the
...
Consequences of publishing early, and how each is handled:
  ...
  - The description says plainly that it is in preparation. If the flag is ever
    ...
    thin course.
  - Reconciles the module list on every run, so module 9
...
ORDER = ["auditor_role", "getting_data", "master_data", "procure_pay", "inventory", "revenue_pos", "access", "test_design"]
...
TRACK = {
    ...
    "seat_price": 85000,
    "description": (
        "IN PREPARATION — eight of nine modules published for review. "
