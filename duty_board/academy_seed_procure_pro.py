"""ZhiftERP Procurement Professional track seed — the buying curriculum.
...
ORDER = ["suppliers", "items_costs", "material_requests", "rfq_quotes", "purchase_orders", "receiving", "purchase_invoice", "advanced_buying"]
...
def seed_procure_pro_track():
	...
	if not frappe.db.exists("Duty Product", "ZhiftERP Procurement"):
		...
		print("created Duty Product: ZhiftERP Procurement")
