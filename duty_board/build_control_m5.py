...
QUESTIONS = [
 ...
 Q("Comparing shrinkage across branches of different formats requires you to first:", ["Convert to naira", "Group by format and compare within the group", "Apply one estate threshold", "Exclude outliers"], 1,
   "The outlier that survives grouping is the interesting one.", "Ch8 §3", "Shrinkage analytics"),
