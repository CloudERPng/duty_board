...
ORDER = ["read_pl", "read_bs", "profit_cash", "cost", "pricing", "budgets"]
...
def seed_finance_track():
    ...
    print("Modules 7 and 8 of the blueprint are not written yet — the track is "
          "sellable only once the set is complete.")
